...
from momaland.learning.utils import autotag, policy_evaluation_mo
...
if __name__ == "__main__":
    ...
    ols = LinearSupport(num_objectives=reward_dim, epsilon=0.0001, verbose=args.debug)
    weight_number = 0
    value = []
